...
try:
    ...
    """
    from APP_BUDGET_164.database import database_tools
    from APP_BUDGET_164.essais_wtf_forms import gestion_essai_wtf
    from APP_BUDGET_164.essais_wtf_forms import gestion_wtf_forms_demo_select
    from APP_BUDGET_164.genres import gestion_genres_crud
    from APP_BUDGET_164.demos_om_164 import routes_demos


    from APP_BUDGET_164.categorie import gestion_categorie_crud
    from APP_BUDGET_164.categorie import gestion_categorie_wtf_forms

    from APP_BUDGET_164.compte import gestion_compte_crud
    from APP_BUDGET_164.compte import gestion_compte_wtf_forms

    from APP_BUDGET_164.films_genres import gestion_films_genres_crud
    from APP_BUDGET_164.erreurs import msg_avertissements

    from APP_BUDGET_164.films import gestion_films_crud
    from APP_BUDGET_164.films import gestion_films_wtf_forms

    from APP_BUDGET_164.revenu import gestion_revenu_crud
    from APP_BUDGET_164.revenu import gestion_revenu_wtf_forms
